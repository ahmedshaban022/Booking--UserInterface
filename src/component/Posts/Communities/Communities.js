        ...
        >
          <Typography sx={{ width: "33%", flexShrink: 0 }}>
            <p className="ms-6 my-1 fw-bold">
              ...
              {t("Posts.Communities.Coronavirus (COVID-19) Support")}
            </p>
          </Typography>
        ...
        <AccordionDetails>
          <Typography>
            <p className="ms-5 my-1">
              {t(
                "Posts.Communities.Get the travel advice you need Read more about possible travel restrictions before you go"
              )}
            </p>
            <div className="mt-3 ms-5 my-1">
              <a className="text-decoration-none" href="#">
                {t("Posts.Communities.Read More")}
              </a>
            </div>
          </Typography>
        </AccordionDetails>
