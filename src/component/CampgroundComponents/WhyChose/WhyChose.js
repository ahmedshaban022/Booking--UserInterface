    ...
    <>
      <div className="my-4 mt-5">
        <h4 className="fw-bold">
          {t("CampgroundComponents.WhyChose.5 Reasons to choose")}{" "}
      ...
      <div class="d-flex flex-wrap">
        <div className="d-flex my-3">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t("CampgroundComponents.WhyChose.Prices you can't beat!")}
            </h5>
          </div>
        </div>
        <div className="d-flex my-3 ms-3">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t("CampgroundComponents.WhyChose.Booking is safe")}
            </h5>
          </div>
        </div>
        <div className="d-flex my-3 ms-3">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t("CampgroundComponents.WhyChose.Manage your bookings online")}
            </h5>
          </div>
        </div>
        <div className="d-flex my-3 me-1">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t("CampgroundComponents.WhyChose.The staff speak English")}
            </h5>
          </div>
        </div>
        <div className="d-flex my-3">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t(
                "CampgroundComponents.WhyChose.Great location and facilities for couples"
              )}
            </h5>
          </div>
        </div>
