    ...
    <>
      <div className="my-4 mt-5">
        <h4 className="fw-bold">
          {t("HotelPage.WhyChose.5 reasons to choose")} {props.hotel.hotelName}
        </h4>
      </div>
      ...
      <div class="d-flex flex-wrap">
        <div className="d-flex my-3">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t("HotelPage.WhyChose.Prices you can't beat!")}
            </h5>
          </div>
        </div>
        <div className="d-flex my-3 ms-3">
          ...
          <div className="ms-2">
            <h5 className="mt-2">{t("HotelPage.WhyChose.Booking is safe")}</h5>
          </div>
        </div>
        <div className="d-flex my-3 ms-3">
          <div className="bgColor">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t("HotelPage.WhyChose.Manage your bookings online")}
            </h5>
          </div>
        </div>
        <div className="d-flex my-3 me-1">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t("HotelPage.WhyChose.The staff speak English")}
            </h5>
          </div>
        </div>
        <div className="d-flex my-3">
          ...
          <div className="ms-2">
            <h5 className="mt-2">
              {t(
                "HotelPage.WhyChose.Great location and facilities for couples"
              )}
            </h5>
          </div>
        </div>
